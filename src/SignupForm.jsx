...
const SignupForm= () => {
  ...
  const handlePasswordChange= (event)=>{
    ...
    passwordRequirements[0].classList.toggle('password-requirement-valid', isLengthValid);
    passwordRequirements[1].classList.toggle('password-requirement-valid', hasUppercase);
    passwordRequirements[2].classList.toggle('password-requirement-valid', regex);
    ...
    <div className="container">
      ...
      <form className="mt-4" onSubmit={handleSubmit}>
        ...
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="username" name="username" placeholder="User Name" style={{ width: '50%' }} required/>
        </div>
        <div className="mb-3">
          <label htmlFor="email" className="form-label">
            Email address
          </label>
          <input type="email" className="form-control" id="email" name="email" placeholder="Enter email"style={{ width: '50%' }} required />
        </div>
        <div className="mb-3">
          ...
          <input
            ...
            placeholder="Enter password" style={{ width: '50%' }}required
